    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 md:p-6">
                ...
                <Card className="max-w-2xl">
                    <CardHeader>
                        ...
                        <CardDescription>Update the details of this user account</CardDescription>
                    </CardHeader>
                    <CardContent>
            ...
            <Dialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Are you sure you want to cancel? All changes will be lost.</DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
            ...
            <Dialog open={showSubmitDialog} onOpenChange={setShowSubmitDialog}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Confirm Update User</DialogTitle>
